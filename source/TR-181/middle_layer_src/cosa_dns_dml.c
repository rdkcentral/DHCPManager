...
extern ANSC_HANDLE g_DnsObject;
/***********************************************************************
 IMPORTANT NOTE:
...
{
    UNREFERENCED_PARAMETER(hInsContext);
    PCOSA_DATAMODEL_DNS             pMyObject    = (PCOSA_DATAMODEL_DNS)g_DnsObject;
...
{
    PCOSA_DATAMODEL_DIAG            pMyObject           = (PCOSA_DATAMODEL_DIAG)g_DnsObject;
