    ...
    )
{
    ...
    ******************************************/
    ...
    for ( ulIndex = 0; ulIndex < poolCount; ulIndex++ )
    {
        ...
        if ( returnStatus != ANSC_STATUS_SUCCESS )
        {
            AnscFreeMemory(pPool);/* free unused resource before exit*/
            pPool = NULL;
            break;
        }
    ...
    )
{
    ...
    for ( ulIndex = 0; ulIndex < ulEntryCount; ulIndex++ )
    {
        ...
        for ( ulIndex2 = 0; ulIndex2 < ulEntryCount2; ulIndex2++ )
        {
            ...
            {
                returnStatus = ANSC_STATUS_FAILURE;
                AnscFreeMemory( pDhcpv4ReqOpt ); /* free unused resource before exit*/
                pDhcpv4ReqOpt = NULL;
                goto EXIT2;
            }
    ...
    SentOption:
        ...
        */
        ...
        for ( ulIndex2 = 0; ulIndex2 < ulEntryCount2; ulIndex2++ )
        {
            ...
            {
                AnscFreeMemory(pDhcpv4SndOpt); /* free unused resource before exit*/
                pDhcpv4SndOpt = NULL;
                returnStatus = ANSC_STATUS_FAILURE;
                goto EXIT2;
            }
    ...
    */
    ...
    for ( ulIndex = 0; ulIndex < ulEntryCount; ulIndex++ )
    {
        ...
        {
            returnStatus = ANSC_STATUS_FAILURE;
            AnscFreeMemory( pDhcpv4X_COM_CISCO_SAddr ); /* free unused resource before exit*/
            pDhcpv4X_COM_CISCO_SAddr = NULL;

            if( pAliasX_COM_CISCO_SAddr )
            {
                AnscFreeMemory( pAliasX_COM_CISCO_SAddr ); /* free unused resource before exit*/
                pAliasX_COM_CISCO_SAddr = NULL;
            }
    ...
    */
    ...
    for ( ulIndex = 0; ulIndex < ulEntryCount; ulIndex++ )
    {
        ...
        for ( ulIndex2 = 0; ulIndex2 < ulEntryCount2; ulIndex2++ )
        {
            ...
            {
                AnscFreeMemory(pDhcpv4StaticAddr);/* free unused resource before exit*/
        ...
        for ( ulIndex2 = 0; ulIndex2 < ulEntryCount2; ulIndex2++ )
        {
            ...
            {
                AnscFreeMemory(pDhcpv4Option); /* free unused resource before exit*/
                pDhcpv4Option = NULL;
                returnStatus = ANSC_STATUS_FAILURE;
                goto EXIT2;
            }
